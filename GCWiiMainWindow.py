...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label_boxArtWork = QtWidgets.QLabel(self.centralwidget)
        self.label_boxArtWork.setAlignment(QtCore.Qt.AlignCenter)
        self.label_boxArtWork.setObjectName("label_boxArtWork")
        self.horizontalLayout.addWidget(self.label_boxArtWork)
        self.label_dicArtWork = QtWidgets.QLabel(self.centralwidget)
        self.label_dicArtWork.setAlignment(QtCore.Qt.AlignCenter)
        self.label_dicArtWork.setObjectName("label_dicArtWork")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_boxArtWork.setText(_translate("MainWindow", "Box"))
        self.label_dicArtWork.setText(_translate("MainWindow", "Disc"))
