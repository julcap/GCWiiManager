...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.progressBar_source = QtGui.QProgressBar(self.centralwidget)
        self.progressBar_source.setMaximumSize(QtCore.QSize(16777215, 15))
        self.progressBar_source.setProperty("value", 24)
        self.progressBar_source.setObjectName(_fromUtf8("progressBar_source"))
        self.verticalLayout_4.addWidget(self.progressBar_source)
